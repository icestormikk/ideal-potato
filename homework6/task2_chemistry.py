...
with open(file_name,"w") as file:
    ...
    #кол-во возможных молекул найдём по следующей формуле: min(n(C)(общ.) / n(C)(в одной мол.), n(H)(общ.) / n(H)(в одной мол.), n(O)(общ.) / n(O)(в одной мол.)), где n(X) - кол-во атомов элемента X 
